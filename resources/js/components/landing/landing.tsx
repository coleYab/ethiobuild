    ...
    return (
        <div className="md:px-16 flex flex-col">
                            ...
                            <div className="absolute -right-4 -top-4 h-24 w-24 rounded-xl bg-orange-500 p-2 shadow-lg md:-right-8 md:-top-8 md:h-32 md:w-32">
                                <div className="flex h-full w-full items-center justify-center rounded-lg bg-white">
                                    <div className="text-center">
                                        ...
                                        <div className="text-xs text-gray-600 dark:text-white md:text-sm">Cost Saving</div>
                                    </div>
                                </div>
                            </div>
                            <div className="absolute -bottom-4 -left-4 h-24 w-24 rounded-xl bg-amber-500 p-2 shadow-lg md:-bottom-8 md:-left-8 md:h-32 md:w-32">
                                <div className="flex h-full w-full items-center justify-center rounded-lg bg-white">
                                    <div className="text-center">
                                        ...
                                        <div className="text-xs text-gray-600 dark:text-white md:text-sm">Faster Delivery</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-20 md:py-32">
                <div className="container">
                    <div className="mx-auto max-w-2xl text-center mb-16">
                        <h2 className="text-3xl font-bold tracking-tight dark:text-white sm:text-4xl">What Our Users Say</h2>
                        <p className="mt-4 text-lg text-gray-600 dark:text-white">
            ...
            <section className="py-20 md:py-32">
                <div className="container">
                    <div className="mx-auto max-w-3xl text-center">
                        <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl dark:text-white">
